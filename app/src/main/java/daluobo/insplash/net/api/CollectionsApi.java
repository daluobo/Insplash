...
public interface CollectionsApi {
    ...
    LiveData<ApiResponse<List<Photo>>> photos(@Path("id") String id,
                                              @Query("page") int page,
                                              @Query("per_page") int per_page);
    ...
    LiveData<ApiResponse<CollectPhoto>> addToCollection(@Path("collection_id") String id,
                                                        @Field("collection_id") String collectionId,
                                                        @Field("photo_id") String photoId);

    @DELETE("/collections/{collection_id}/remove")
    LiveData<ApiResponse<CollectPhoto>> removeFromCollection(@Path("collection_id") String id,
                                                             @Query("collection_id") String collectionId,
                                                             @Query("photo_id") String photoId);

    @PUT("/collections/{id}")
    LiveData<ApiResponse<Collection>> updateCollection(@Path("id") String id,
